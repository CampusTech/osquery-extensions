...
func TestResolveColor(t *testing.T) {
	cases := []struct {
		...
		{"Universal code 11 Sky Blue (MacBook Air)", "Mac15,12", "MacBook Air", 11, true, "Sky Blue"},
		{"Universal code 11 Sky Blue (MacBook Pro)", "Mac16,5", "MacBook Pro", 11, true, "Sky Blue"},
